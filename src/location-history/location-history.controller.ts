...
export class LocationHistoryController {
  ...
  @ApiOperation({ 
    ...
    description: 'Saves a new location record for the authenticated user. Detects city name automatically if not provided using reverse geocoding.',
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves all location history records for the authenticated user, ordered by arrival date (most recent first).',
  })
  @ApiResponse({ 
    status: 200, 
